	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
				...
				|| (grade == L2Item.CRYSTAL_S && FishshotId != 6540))
		{
			...
			activeChar.sendPacket(
					new SystemMessage(SystemMessage.WRONG_FISHINGSHOT_GRADE));
			return;
		}
		...
		MagicSkillUser MSU = new MagicSkillUser(activeChar, _skillIds[grade], 1,
				0, 0);

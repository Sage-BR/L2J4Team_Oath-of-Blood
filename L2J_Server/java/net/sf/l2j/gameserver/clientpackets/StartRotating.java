...
public class StartRotating extends ClientBasePacket
{
	 ...
	 * sample
	 *
	 * 4a fb 0f 00 00 // degree (goes from 0 to 65535) 01 00 00 00 // side (01
	 * 00 00 00 = right, ff ff ff ff = left)
	 *
	 * format: cdd
	 *
	 * @param decrypt
	...
	void runImpl()
	{
		if (getClient().getActiveChar() == null)
			return;
		BeginRotation br = new BeginRotation(getClient().getActiveChar(),
				_degree, _side);

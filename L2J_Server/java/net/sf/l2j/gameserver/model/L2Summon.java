...
public abstract class L2Summon extends L2PlayableInstance
{
	...
	public L2Summon(int objectId, L2NpcTemplate template, L2PcInstance owner)
	{
		...
		setXYZInvisible(owner.getX() + 50, owner.getY() + 100,
				owner.getZ() + 100);
	}
	...
	public final SummonKnownList getKnownList()
	{
		if (super.getKnownList() == null
				|| !(super.getKnownList() instanceof SummonKnownList))
	...
	public SummonStatus getStatus()
	{
		if (super.getStatus() == null
				|| !(super.getStatus() instanceof SummonStatus))
	...
	public void deleteMe(L2PcInstance owner)
	{
		...
		// FIXME: I think it should really drop items to ground and only owner
		// can take for a while
		giveAllToOwner();
		decayMe();
	...
	public void useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (getCurrentHp() <= skill.getHpConsume())
		{
			...
			if (getOwner() != null)
				getOwner().sendPacket(
						new SystemMessage(SystemMessage.NOT_ENOUGH_HP));
			return;
		}
		...
		if (skill.isOffensive())
		{
			...
			{
				if (!target.isAttackable() && getOwner() != null && (getOwner()

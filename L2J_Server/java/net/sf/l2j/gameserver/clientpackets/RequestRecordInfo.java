...
public class RequestRecordInfo extends ClientBasePacket
{
	...
	void runImpl()
	{
		...
		for (L2Object object : _activeChar.getKnownList().getKnownObjects()
				.values())
		{
			if (object == null)
				continue;
			...
			else
			{
				...
				} else if (object instanceof L2BoatInstance)
				{
							...
							&& object != _activeChar.getBoat())
					{
						...
						((L2BoatInstance) object)
								.sendVehicleDeparture(_activeChar);
					}
					...
					_activeChar.sendPacket(
							new NpcInfo((L2NpcInstance) object, _activeChar));
				else if (object instanceof L2Summon)
				{
					L2Summon summon = (L2Summon) object;

					// Check if the L2PcInstance is the owner of the Pet
					if (equals(summon.getOwner()))
					{
						...
						_activeChar
								.sendPacket(new NpcInfo(summon, _activeChar));
				} else if (object instanceof L2PcInstance)
				{
					...
					if (otherPlayer.isInBoat())
					{
						...
						_activeChar.sendPacket(new GetOnVehicle(otherPlayer,
								otherPlayer.getBoat(),
				...
				if (object instanceof L2Character)
				{
					...
					// sending Server->Client packet
					// MoveToPawn/CharMoveToLocation and AutoAttackStart to the
					// L2PcInstance

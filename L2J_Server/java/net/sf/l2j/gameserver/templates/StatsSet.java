 ...
 *         key) and addition of a whole set in the current one.
 */
public final class StatsSet
{
	 ...
	 *
	 * @param newSet
	 *            : StatsSet pointing out the list of couples to add in the
	 *            current set
	 */
	...
	public boolean getBool(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"Boolean value required, but not specified");
		...
		{
			throw new IllegalArgumentException(
					"Boolean value required, but found: " + val);
		}
	}

	/**
	 * Return the boolean associated to the key put in parameter ("name"). If
	 * the value associated to the key is null, this method returns the value of
	 * the parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : boolean designating the default value if value associated
	...
	/**
	 * Returns the int associated to the key put in parameter ("name"). If the
	 * value associated to the key is null, this method returns the value of the
	 * parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : byte designating the default value if value associated with
	 *            the key is null
	...
	public byte getByte(String name, byte deflt)
	{
		...
		{
			throw new IllegalArgumentException(
					"Byte value required, but found: " + val);
		}
	}
	...
	public byte getByte(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"Byte value required, but not specified");
		if (val instanceof Number)
			return ((Number) val).byteValue();
		try
		{
	...
	/**
	 * Returns the short associated to the key put in parameter ("name"). If the
	 * value associated to the key is null, this method returns the value of the
	 * parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : short designating the default value if value associated with
	 *            the key is null
	...
	public short getShort(String name, short deflt)
	{
		...
		{
			throw new IllegalArgumentException(
					"Short value required, but found: " + val);
		}
	}
	...
	public short getShort(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"Short value required, but not specified");
		if (val instanceof Number)
			return ((Number) val).shortValue();
		try
		{
	...
	public int getInteger(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"Integer value required, but not specified");
		if (val instanceof Number)
		...
		{
			throw new IllegalArgumentException(
					"Integer value required, but found: " + val);
		}
	}
	 ...
	 *            : String designating the key in the set
	 * @param deflt
	 *            : int designating the default value if value associated with
	 *            the key is null
	 * @return int : value associated to the key
	 */
	...
	/**
	 * Returns the long associated to the key put in parameter ("name"). If the
	 * value associated to the key is null, this method returns the value of the
	 * parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : long designating the default value if value associated with
	 *            the key is null
	 * @return long : value associated to the key
	 */
	...
	public float getFloat(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"Float value required, but not specified");
		if (val instanceof Number)
		...
		{
			throw new IllegalArgumentException(
					"Float value required, but found: " + val);
		}
	}

	/**
	 * Returns the float associated to the key put in parameter ("name"). If the
	 * value associated to the key is null, this method returns the value of the
	 * parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : float designating the default value if value associated with
	 *            the key is null
	 * @return float : value associated to the key
	 */
	...
	/**
	 * Returns the double associated to the key put in parameter ("name"). If
	 * the value associated to the key is null, this method returns the value of
	 * the parameter deflt.
	 *
	 * @param name
	...
	public String getString(String name)
	{
		...
		if (val == null)
			throw new IllegalArgumentException(
					"String value required, but not specified");
		return String.valueOf(val);
	}

	/**
	 * Returns the String associated to the key put in parameter ("name"). If
	 * the value associated to the key is null, this method returns the value of
	 * the parameter deflt.
	 *
	 * @param name
	 *            : String designating the key in the set
	 * @param deflt
	 *            : String designating the default value if value associated
	 *            with the key is null
	 * @return String : value associated to the key
	 */
	 ...
	 *            : String designating the key in the set
	 * @param enumClass
	 *            : Class designating the class of the value associated with the
	 *            key in the set
	 * @return Enum<T>
	 */
	...
	public <T extends Enum<T>> T getEnum(String name, Class<T> enumClass)
	{
		Object val = _set.get(name);
		if (val == null)
			throw new IllegalArgumentException("Enum value of type "
					+ enumClass.getName() + " required, but not specified");
		...
		{
			throw new IllegalArgumentException("Enum value of type "
					+ enumClass.getName() + "required, but found: " + val);
		}
	}

	/**
	 * Returns an enumeration of &lt;T&gt; from the set. If the enumeration is
	 * empty, the method returns the value of the parameter "deflt".
	 *
	 * @param <T>
	 *            : Class of the enumeration returned
	 * @param name

...
public class L2FestivalMonsterInstance extends L2MonsterInstance
{
	...
	/**
	 * Constructor of L2FestivalMonsterInstance (use L2Character and
	 * L2NpcInstance constructor).<BR>
	 * <BR>
	 *
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the L2Character constructor to set the _template of the
	 * L2FestivalMonsterInstance (copy skills from template to object and link
	...
	/**
	 * Actions:
	 * <li>Check if the killing object is a player, and then find the party they
	 * belong to.</li>
	 * <li>Add a blood offering item to the leader of the party.</li>
	 * <li>Update the party leader's inventory to show the new item
	 * addition.</li>
	 */
	@Override
	public void doItemDrop(L2Character lastAttacker)
	{
		...
		L2ItemInstance addedOfferings = partyLeader.getInventory().addItem(
				"Sign", SevenSignsFestival.FESTIVAL_OFFERING_ID,
				_bonusMultiplier, partyLeader, this);

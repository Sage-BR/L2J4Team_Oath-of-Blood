 ...
 *
 *
 * sample 0000: 68 b1010000 48 00 61 00 6d 00 62 00 75 00 72 00 67 00 00 00
 * H.a.m.b.u.r.g... 43 00 61 00 6c 00 61 00 64 00 6f 00 6e 00 00 00
 * C.a.l.a.d.o.n... 00000000 crestid | not used (nuocnam) 00000000 00000000
 * 00000000 00000000 22000000 00000000 00000000 00000000 ally id 00 00 ally name
 * 00000000 ally crrest id
 *
 * 02000000
 *
 * 6c 00 69 00 74 00 68 00 69 00 75 00 6d 00 31 00 00 00 l.i.t.h.i.u.m...
 * 0d000000 level 12000000 class id 00000000 01000000 offline 1=true 00000000
 *
 * 45 00 6c 00 61 00 6e 00 61 00 00 00 E.l.a.n.a... 08000000 19000000 01000000
 * 01000000 00000000
 *
 *
...
public class PledgeShowMemberListAll extends ServerBasePacket
{
	...
	// Logger.getLogger(PledgeShowMemberListAll.class.getName());
	...
	void writePledge(int mainOrSubpledge)
	{
		...
		for (L2ClanMember m : _members)
		{
			...
			writeD(0); // c5 makes the name yellow. member is in academy and has
						// a sponsor
		}
	}

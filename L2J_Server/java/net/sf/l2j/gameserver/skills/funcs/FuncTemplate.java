...
public final class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applayCond, String func,
			Stats stat, int order, Lambda lambda)
	{
		...
		{
			_func = Class
					.forName("net.sf.l2j.gameserver.skills.funcs.Func" + func);
	...
	public Func getFunc(Env env, Object owner)
	{
		...
		try
		{
			Func f = (Func) _constructor.newInstance(_stat, _order, owner,
					_lambda);
			if (_applayCond != null)

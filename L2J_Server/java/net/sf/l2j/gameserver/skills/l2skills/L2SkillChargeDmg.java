...
public class L2SkillChargeDmg extends L2Skill
{
	...
	public void useSkill(L2Character caster, L2Object[] targets)
	{
		...
		if (this.getTargetType() != SkillTargetType.TARGET_AREA
				&& this.getTargetType() != SkillTargetType.TARGET_MULTIFACE)
		...
		for (L2Object target2 : targets)
		{
			...
			boolean crit = Formulas.getInstance()
					.calcCrit(caster.getCriticalHit(target, this));
			boolean soul = (weapon != null && weapon
					.getChargedSoulshot() == L2ItemInstance.CHARGED_SOULSHOT
					&& weapon.getItemType() != L2WeaponType.DAGGER);

			int damage = (int) Formulas.getInstance().calcPhysDam(caster,
					target, this, shld, crit, false, soul);

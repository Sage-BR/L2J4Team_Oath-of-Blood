...
public class WearList extends ServerBasePacket
{
	...
	final void writeImpl()
	{
		...
		{
			if (item.getItem().getCrystalType() <= _expertise
					&& item.isEquipable())
				newlength++;
		}
		writeH(newlength);
		...
		for (L2ItemInstance item : _list)
		{
					...
					&& item.isEquipable())
			{
				...
				if (item.getItem()
						.getType1() != L2Item.TYPE1_ITEM_QUESTITEM_ADENA)
				{
					writeH(item.getItem().getBodyPart()); // rev 415 slot
															// 0006-lr.ear
															// 0008-neck
															// 0030-lr.finger
															// 0040-head 0080-??
				...
				{
					writeH(0x00); // rev 415 slot 0006-lr.ear 0008-neck
									// 0030-lr.finger 0040-head 0080-??
									// 0100-l.hand 0200-gloves 0400-chest
									// 0800-pants 1000-feet 2000-?? 4000-r.hand
									// 8000-r.hand
				}

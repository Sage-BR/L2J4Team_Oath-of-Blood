...
public class ManaHeal implements ISkillHandler
{
	...
	L2Character actChar, L2Skill skill, L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			{
				mp = (skill.getSkillType() == SkillType.MANARECHARGE)
						? target.calcStat(Stats.RECHARGE_MP_RATE, mp, null,
								null)
						: mp;
			}
			...
			if (actChar instanceof L2PcInstance && actChar != target)
			{
				SystemMessage sm = new SystemMessage(
						SystemMessage.S2_MP_RESTORED_BY_S1);

...
public class CharKnownList extends ObjectKnownList
{
	...
	/**
	 * Return True if the L2PcInstance is in _knownPlayer of the
	 * L2Character.<BR>
	 * <BR>
	 *
	 * @param player
	...
	{
		return getActiveChar() == player
				|| getKnownPlayers().containsKey(player.getObjectId());
	}
	...
	public final Map<Integer, L2PcInstance> getKnownPlayers()
	{
		if (_KnownPlayers == null)
			_KnownPlayers = new FastMap<Integer, L2PcInstance>()
					.setShared(true);

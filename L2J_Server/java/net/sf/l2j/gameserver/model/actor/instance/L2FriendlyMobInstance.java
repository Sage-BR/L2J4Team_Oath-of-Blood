...
/**
 * This class represents Friendly Mobs lying over the world. These friendly mobs
 * should only attack players with karma > 0 and it is always aggro, since it
 * just attacks players with karma
 *
...
public class L2FriendlyMobInstance extends L2Attackable
{
	...
	public final FriendlyMobKnownList getKnownList()
	{
		if (super.getKnownList() == null
				|| !(super.getKnownList() instanceof FriendlyMobKnownList))

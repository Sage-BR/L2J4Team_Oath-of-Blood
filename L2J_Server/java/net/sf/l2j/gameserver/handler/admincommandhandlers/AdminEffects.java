...
/**
 * This class handles following admin commands: - invis / invisible = make
 * yourself invisible - vis / visible = make yourself visible
 *
 */
public class AdminEffects implements IAdminCommandHandler
{
	...
	private static String[] _adminCommands =
		{ "admin_invis", "admin_invisible", "admin_vis", "admin_visible",
				"admin_earthquake", "admin_bighead", "admin_shrinkhead",
				"admin_gmspeed", "admin_unpara_all", "admin_para_all",
				"admin_unpara", "admin_para", "admin_polyself",
				"admin_unpolyself", "admin_changename", "admin_clearteams",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (command.equals("admin_invis") || command.equals("admin_invisible"))
		{
			...
			// activeChar.teleToLocation(activeChar.getX(), activeChar.getY(),
			// activeChar.getZ());
		}
		...
		if (command.startsWith("admin_earthquake"))
		{
			try
			{
				...
				Earthquake eq = new Earthquake(activeChar.getX(),
						activeChar.getY(), activeChar.getZ(), intensity,
						duration);
		...
		if (command.startsWith("admin_gmspeed"))
		{
			...
			try
			{
				...
				{
					L2Skill gmSpeedSkill = SkillTable.getInstance()
							.getInfo(7029, val);
			...
			try
			{
				...
				try
				{
					...
					if (player instanceof L2PcInstance)
						L2World.getInstance()
								.removeFromAllPlayers((L2PcInstance) player);
					player.setName(name);
					if (player instanceof L2PcInstance)
					...
					{
						NpcInfo info1 = new NpcInfo((L2NpcInstance) player,
								null);
						player.broadcastPacket(info1);
					}

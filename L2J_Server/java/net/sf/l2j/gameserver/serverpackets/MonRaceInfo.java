...
/**
 * sample 06 8f19904b 2522d04b 00000000 80 950c0000 4af50000 08f2ffff 0000 - 0
 * damage (missed 0x80) 06 85071048 bc0e504b 32000000 10 fc41ffff fd240200
...
public class MonRaceInfo extends ServerBasePacket
{
	...
	public MonRaceInfo(int unknown1, int unknown2, L2NpcInstance[] monsters,
			int[][] speeds)
	{
		/*
...
//  0xf3;;EtcStatusUpdatePacket;ddddd
	...
	final void writeImpl()
	{
		...
		for (int i = 0; i < 8; i++)
		{
			// System.out.println("MOnster "+(i+1)+" npcid
			// "+_monsters[i].getNpcTemplate().getNpcId());
			...
			/*
			 * writeD(0x77776666); writeD(0x99998888); writeD(0xBBBBAAAA);
			 * writeD(0xDDDDCCCC); writeD(0xFFFFEEEE); //
			 */
			writeD(0);
		}
	}

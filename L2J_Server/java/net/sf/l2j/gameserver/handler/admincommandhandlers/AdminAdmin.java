...
public class AdminAdmin implements IAdminCommandHandler
{
		...
		else if (command.startsWith("admin_play_sounds"))
		{
			try
			{
				AdminHelpPage.showHelpPage(activeChar,
						"songs/songs" + command.substring(17) + ".htm");
		...
		else if (command.startsWith("admin_silence"))
		{
												...
												// mode
			{
				...
				activeChar.sendPacket(new SystemMessage(
						SystemMessage.MESSAGE_ACCEPTANCE_MODE));
			} else
			{
				activeChar.setMessageRefusal(true);
				activeChar.sendPacket(
						new SystemMessage(SystemMessage.MESSAGE_REFUSAL_MODE));
			}
		}
		...
		} else if (command.startsWith("admin_reload"))
		{
			...
			try
			{
				...
				} else if (type.startsWith("htm"))
				{
					...
					activeChar.sendMessage("Cache[HTML]: "
				...
				} else if (type.startsWith("instancemanager"))
				{
					...
					activeChar.sendMessage(
							"All instance manager has been reloaded");
				}
			} catch (Exception e)
			{
				activeChar.sendMessage(
						"Usage:  //reload <multisell|skill|npc|htm|item|instancemanager>");
			}
		}
	 ...
	 *
	 * @param type
	 *            - atmosphere type (signssky,sky)
	 * @param state
	 *            - atmosphere state(night,day)
	 */
	public void adminAtmosphere(String type, String state,
			L2PcInstance activeChar)
	{
		...
		} else
		{
			...
			sm.addString(
					"Only sky and signsky atmosphere type allowed, damn u!");
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append(
				"<button value=\"Land\" action=\"bypass -h admin_unride\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append("<br>");
		replyMSG.append(
				"<button value=\"Find Mammon\" action=\"bypass -h admin_mammon_find\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append(
				"<button value=\"Mob Ctrl Menu\" action=\"bypass -h admin_mobmenu\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append("<br1>");
		replyMSG.append(
				"<button value=\"List Spawns\" action=\"bypass -h admin_list_spawns $menu_command\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append(
		...
		replyMSG.append(
				"<button value=\"Set Karma\" action=\"bypass -h admin_setkarma $menu_command\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append(
				"<button value=\"Clear Karma\" action=\"bypass -h admin_nokarma\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		replyMSG.append("<br>");
		replyMSG.append(
		...
		replyMSG.append(
				"<button value=\"Invis\" action=\"bypass -h admin_invis\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Kill\" action=\"bypass -h admin_kill\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Kick\" action=\"bypass -h admin_kick $menu_command\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Open\" action=\"bypass -h admin_open\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("<br><tr><td>");
		replyMSG.append(
				"<button value=\"Revis\" action=\"bypass -h admin_vis\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Delete\" action=\"bypass -h admin_delete\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Ban\" action=\"bypass -h admin_ban $menu_command\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Close\" action=\"bypass -h admin_close\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table><br><table width=200><tr><td>");
		replyMSG.append(
				"<button value=\"Chat Ban\" action=\"bypass -h admin_banchat $menu_command\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td><td>");
		replyMSG.append(
				"<button value=\"Chat UnBan\" action=\"bypass -h admin_unbanchat $menu_command\" width=90 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\">");
		...
		replyMSG.append(
				"<tr><td>Server Software: Server software running L2J version 3.0.1 nightly created by L2Chef and the L2J team.</td></tr>");

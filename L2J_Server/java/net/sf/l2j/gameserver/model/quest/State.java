...
public class State
{
	 ...
	 *
	 * @param name
	 *            : String pointing out the name of the quest
	 * @param quest
	 *            : Quest
	 */
	 ...
	 *
	 * @param npcId
	 *            : int designating the ID of the NPC
	 * @param itemId
	 *            : int designating the ID of the item dropped
	 * @param chance
	 *            : int designating the chance the item dropped
	 */

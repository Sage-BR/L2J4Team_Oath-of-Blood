...
public class RequestMakeMacro extends ClientBasePacket
{
	 ...
	 * sample
	 *
	 * c1 d // id S // macro name S // unknown desc S // unknown acronym c //
	 * icon c // count
	 *
	...
	public RequestMakeMacro(ByteBuffer buf, ClientThread client)
	{
		...
		if (Config.DEBUG)
			System.out.println("Make macro id:" + _id + "\tname:" + _name
					+ "\tdesc:" + _desc + "\tacronym:" + _acronym + "\ticon:"
					+ _icon + "\tcount:" + _count);
		for (int i = 0; i < _count; i++)
		{
			...
			if (Config.DEBUG)
				System.out.println("entry:" + entry + "\ttype:" + type + "\td1:"
						+ d1 + "\td2:" + d2 + "\tcommand:" + command);
		}

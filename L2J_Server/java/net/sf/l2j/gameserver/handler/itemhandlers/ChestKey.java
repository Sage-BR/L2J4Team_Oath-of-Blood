...
public class ChestKey implements IItemHandler
{
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		L2Skill skill = SkillTable.getInstance().getInfo(2065, 1);// box key
																	// skill
		...
		} else
		{
			...
			if (!(activeChar.isInsideRadius(chest, INTERACTION_DISTANCE, false,
					false)))
			{
			...
			if (!chest.isBox())
			{
				...
				playable.destroyItem("Consume", item.getObjectId(), 1, null,
						false);
			...
			switch (itemId)
			{
			case 5197:// grade 8 - 60% for open ONLY chest lv1,decrese % on high
						// chest lvl
			{
				if (chest.getLevel() == 1)
				{
				...
				break;
			case 5198:// grade 7 - 60% for open ONLY chest lv 10,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5199:// grade 6 - 60% for open ONLY chest lv 20,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5200:// grade 5 - 60% for open ONLY chest lv 30,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5201:// grade 4 - 60% for open ONLY chest lv 40,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5202:// grade 3 - 60% for open ONLY chest lv 50,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5203:// grade 2 - 60% for open ONLY chest lv 60,decrese % on
						// high chest lvl
			{
				...
				break;
			case 5204:// grade 1 - 60% for open ONLY chest lv 70,decrese % on
						// high chest lvl
			{
				...
				break;
			// Deuxe Chest Key
			case 6665:// grade 1 - 100% for open chest lv 1-19,decrese % on high
						// chest lvl
			{
				if (chestGroup == 1)
				{
				...
				break;
			case 6666:// grade 2 - 100% for open chest lv 20-29,decrese % on
						// high chest lvl
			{
				if (chestGroup < 2)
				{
				...
				break;
			case 6667:// grade 3 - 100% for open chest lv 30-39,decrese % on
						// high chest lvl
			{
				if (chestGroup < 3)
				{
				...
				break;
			case 6668:// grade 4 - 100% for open chest lv 40-49,decrese % on
						// high chest lvl
			{
				if (chestGroup < 4)
				{
				...
				break;
			case 6669:// grade 5 - 100% for open chest lv 50-59,decrese % on
						// high chest lvl
			{
				if (chestGroup < 5)
				{
				...
				break;
			case 6670:// grade 6 - 100% for open chest lv 60-69,decrese % on
						// high chest lvl
			{
				if (chestGroup < 6)
				{
				...
				break;
			case 6671:// grade 7 - 100% for open chest lv 70-79,decrese % on
						// high chest lvl
			{
				if (chestGroup < 7)
				{
				...
				break;
			case 6672:// grade 8 - 100% for open chest lv 80-89,decrese % on
						// high chest lvl
			{
				if (chestGroup < 8)
				{
			...
			if (openChance > 0 && Rnd.get(100) < openChance)
			{
				...
				PlaySound playSound = new PlaySound(
						"interfacesound.inventory_open_01");
			...
			} else
			{
				...
				PlaySound playSound = new PlaySound(
						"interfacesound.system_close_01");
				activeChar.sendPacket(playSound);

...
public class Firework implements IItemHandler
{
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		{
			MagicSkillUser MSU = new MagicSkillUser(playable, activeChar, 2023,
					1, 1, 0);
		...
		{
			MagicSkillUser MSU = new MagicSkillUser(playable, activeChar, 2024,
					1, 1, 0);
			activeChar.sendPacket(MSU);
			activeChar.broadcastPacket(MSU);
		...
		{
			MagicSkillUser MSU = new MagicSkillUser(playable, activeChar, 2025,
					1, 1, 0);
			activeChar.sendPacket(MSU);
			activeChar.broadcastPacket(MSU);

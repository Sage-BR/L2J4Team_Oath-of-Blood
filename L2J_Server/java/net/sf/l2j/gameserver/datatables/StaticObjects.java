...
public class StaticObjects
{
	private static Logger _log = Logger
			.getLogger(StaticObjects.class.getName());
	...
	public StaticObjects()
	{
		...
		parseData();
		_log.config("StaticObject: Loaded " + _staticObjects.size()
				+ " StaticObject Templates.");
	}
	...
	public static L2StaticObjectInstance parse(String line)
	{
		...
		L2StaticObjectInstance obj = new L2StaticObjectInstance(

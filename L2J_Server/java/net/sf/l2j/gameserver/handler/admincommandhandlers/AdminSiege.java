...
/**
 * This class handles all siege commands: Todo: change the class name, and
 * neaten it up
 *
 *
 */
public class AdminSiege implements IAdminCommandHandler
{
	...
	private static String[] _adminCommands =
		{ "admin_siege", "admin_add_attacker", "admin_add_defender",
				"admin_add_guard", "admin_list_siege_clans",
				"admin_clear_siege_list", "admin_move_defenders",
				"admin_spawn_doors", "admin_endsiege", "admin_startsiege",
				"admin_setcastle", "admin_clanhall", "admin_clanhallset",
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (command.startsWith("admin_clanhall"))
		{
			clanhall = ClanHallManager.getInstance()
					.getClanHall(Integer.parseInt(st.nextToken()));
		...
		else
		{
				...
				if (val != "")
				{
					try
					{
						...
						castle.getSiege().getSiegeGuardManager()
								.addSiegeGuard(activeChar, npcId);
					} catch (Exception e)
					{
						activeChar.sendMessage(
								"Value entered for Npc Id wasn't an integer");
					}
				} else
			...
			} else if (command.equalsIgnoreCase("admin_move_defenders"))
			{
				activeChar.sendPacket(
						SystemMessage.sendString("Not implemented yet."));
	...
	public void showCastleSelectPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append(
				"<td>Castles:<br></td><td>ClanHalls:<br></td><td></td></tr><tr>");
		replyMSG.append("<td>");
		...
		for (Castle castle : CastleManager.getInstance().getCastles())
		{
			if (castle != null)
				replyMSG.append(
						"<a action=\"bypass -h admin_siege " + castle.getName()
								+ "\">" + castle.getName() + "</a><br1>");
		}
		...
		for (ClanHall clanhall : ClanHallManager.getInstance().getClanHalls())
		{
			...
			if (clanhall != null)
				replyMSG.append("<a action=\"bypass -h admin_clanhall "
						+ clanhall.getId() + "\">" + clanhall.getName()
						+ "</a><br1>");
		}
	...
	public void showSiegePage(L2PcInstance activeChar, String castleName)
	{
		...
		replyMSG.append(
				"<tr><td><button value=\"Add Attacker\" action=\"bypass -h admin_add_attacker "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"Add Defender\" action=\"bypass -h admin_add_defender "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append(
				"<tr><td><button value=\"List Clans\" action=\"bypass -h admin_list_siege_clans "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"Clear List\" action=\"bypass -h admin_clear_siege_list "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		replyMSG.append("<table>");
		replyMSG.append(
				"<tr><td><button value=\"Move Defenders\" action=\"bypass -h admin_move_defenders "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"Spawn Doors\" action=\"bypass -h admin_spawn_doors "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		replyMSG.append("<table>");
		replyMSG.append(
				"<tr><td><button value=\"Start Siege\" action=\"bypass -h admin_startsiege "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"End Siege\" action=\"bypass -h admin_endsiege "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		replyMSG.append("<table>");
		replyMSG.append(
				"<tr><td><button value=\"Give Castle\" action=\"bypass -h admin_setcastle "
						+ castleName
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		...
		replyMSG.append(
				"<td><button value=\"Add Guard\" action=\"bypass -h admin_add_guard "
						+ castleName
						+ " $value\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("</center>");
		replyMSG.append("</body></html>");
	...
	public void showClanHallPage(L2PcInstance activeChar, ClanHall clanhall)
	{
		...
		// replyMSG.append("<table>");
		// replyMSG.append("<tr><td><button value=\" Owner\" action=\"bypass -h
		// admin_clanhallset " + clanhall.getId() + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		// replyMSG.append("</table>");
		replyMSG.append("<br>");
		// replyMSG.append("<td><button value=\"Add Defender\" action=\"bypass
		// -h admin_add_defender " + castleName + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		// replyMSG.append("<tr><td><button value=\"List Clans\" action=\"bypass
		// -h admin_list_siege_clans " + castleName + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		// replyMSG.append("<td><button value=\"Clear List\" action=\"bypass -h
		// admin_clear_siege_list " + castleName + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		// replyMSG.append("<table>");
		// replyMSG.append("<tr><td><button value=\"Move Defenders\"
		// action=\"bypass -h admin_move_defenders " + castleName + "\" width=80
		// height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		// replyMSG.append("<td><button value=\"Spawn Doors\" action=\"bypass -h
		// admin_spawn_doors " + castleName + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		// replyMSG.append("</table>");
		replyMSG.append("<br>");
		// replyMSG.append("<table>");
		// replyMSG.append("<tr><td><button value=\"Start Siege\"
		// action=\"bypass -h admin_startsiege " + castleName + "\" width=80
		// height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		// replyMSG.append("<td><button value=\"End Siege\" action=\"bypass -h
		// admin_endsiege " + castleName + "\" width=80 height=15
		// back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		// replyMSG.append("</table>");
		replyMSG.append("<table>");
		replyMSG.append(
				"<tr><td><button value=\"Open Doors\" action=\"bypass -h admin_clanhallopendoors "
						+ clanhall.getId()
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"Close Doors\" action=\"bypass -h admin_clanhallclosedoors "
						+ clanhall.getId()
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		replyMSG.append("<table>");
		replyMSG.append(
				"<tr><td><button value=\"Give ClanHall\" action=\"bypass -h admin_clanhallset "
						+ clanhall.getId()
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td>");
		replyMSG.append(
				"<td><button value=\"Take ClanHall\" action=\"bypass -h admin_clanhalldel "
						+ clanhall.getId()
						+ "\" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("<br>");
		...
		// replyMSG.append("<tr><td>NpcId: <edit var=\"value\" width=40>");
		replyMSG.append(
				"<td><button value=\"Teleport self\" action=\"bypass -h admin_clanhallteleportself "
						+ clanhall.getId()
						+ " \" width=80 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
		replyMSG.append("</table>");
		replyMSG.append("</center>");

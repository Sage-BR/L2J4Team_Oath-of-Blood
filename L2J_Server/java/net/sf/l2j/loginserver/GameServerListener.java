...
/**
 * This class waits fro incomming connections from GameServers and launches
 * (@link GameServerThread GameServerThreads}
 *
...
public class GameServerListener extends FloodProtectedListener
{
	protected static Logger _log = Logger
			.getLogger(LoginServer.class.getName());
	...
	public GameServerListener()
	{
		...
		_log.info("Ok, Listening for gameServer on port "

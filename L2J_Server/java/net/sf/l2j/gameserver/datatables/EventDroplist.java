 ...
 * Items are defined in the table <B>allNpcDateDrops</B>. Each Special Event has
 * a start and end date to stop to drop extra Items automaticaly.<BR>
 * <BR>
 */
...
public class EventDroplist
{
	...
	public class DateDrop
	{
		...
		/**
		 * The table containing Item identifier that can be dropped as extra
	...
	/**
	 * Create and Init a new DateDrop then add it to the allNpcDateDrops of
	 * EventDroplist .<BR>
	 * <BR>
	 *
	 * @param items
	 ...
	 * @param count
	 *            The table containing min and max value of this DateDrop
	 * @param chance
	 *            The chance to obtain this drop
	 * @param range
	 *            The DateRange object to add to this DateDrop
	 *
	 */
	public void addGlobalDrop(int[] items, int[] count, int chance,
			DateRange range)
	{
	...
	/**
	 * Return all DateDrop of EventDroplist allNpcDateDrops within the date
	 * range.<BR>
	 * <BR>
	 */

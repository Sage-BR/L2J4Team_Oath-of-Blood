...
/**
 *
 * Thorgrim - 2005 Add 500k adena to the clan warehouse every 2 hours
 *
 */
	...
	public void run()
	{
		try
		{
			...
			if ((warehouse != null) && (_clan.getHasCastle() > 0))
			{
				...
				// Give clan ~1 Secret Book of Giants daily (it's been confirmed
				// that castle owners get these, but method is unknown)
				if (_RunCount % 3 == 0)
				{

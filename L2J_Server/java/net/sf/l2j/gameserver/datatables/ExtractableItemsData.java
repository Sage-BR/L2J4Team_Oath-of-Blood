...
public class ExtractableItemsData
{
	...
	public ExtractableItemsData()
	{
		...
		{
			System.out.println(
					"Extractable items data: Can not find './data/extractable_items.csv'");
			return;
		}
		...
		while (s.hasNextLine())
		{
			...
			{
				System.out.println("Extractable items data: Error in line "
						+ lineCount
			...
			FastList<L2ExtractableProductItem> product_temp = new FastList<>();
			...
			for (int i = 0; i < lineSplit.length - 1; i++)
			{
				...
				L2ExtractableProductItem product = new L2ExtractableProductItem(
						production, amount, chance);
			...
			L2ExtractableItem product = new L2ExtractableItem(itemID,
					product_temp);
			_items.put(itemID, product);
		}

		s.close();
		System.out.println("Extractable items data: Loaded " + _items.size()
				+ " extractable items!");
	}

...
public class DayNightSpawnManager
{
	...
	private static Logger _log = Logger
			.getLogger(DayNightSpawnManager.class.getName());
	...
	public void addDayCreature(L2Spawn spawnDat)
	{
		...
		{
			_log.warning(
					"DayNightSpawnManager: Spawn already added into day map");
			return;
		} else
	...
	public void addNightCreature(L2Spawn spawnDat)
	{
		...
		{
			_log.warning(
					"DayNightSpawnManager: Spawn already added into night map");
			return;
		} else
	...
	public void spawnDayCreatures()
	{
		try
		{
			if (_nightCreatures.size() != 0)
			{
				...
				_log.info("DayNightSpawnManager: Deleted " + i
						+ " night creatures");
			}
	...
	public void spawnNightCreatures()
	{
		try
		{
			...
			_log.info(
					"DayNightSpawnManager: Spawning " + i + " night creatures");
		} catch (Exception e)
		{
			e.printStackTrace();
		}
	...
	private void specialNightBoss(int mode)
	{
		try
		{
			for (L2Spawn spawn : _bosses.keySet())
			{
				...
				if (boss.getNpcId() == 25328 && boss.getRaidStatus()
						.equals(RaidBossSpawnManager.StatusEnum.ALIVE))

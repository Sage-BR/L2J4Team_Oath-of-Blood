...
public class Attack extends ServerBasePacket
{
	private class Hit
	{
		...
		Hit(L2Object target, int damage, boolean miss, boolean crit,
				boolean shld)
		{
	...
	/**
	 * Add this hit (target, damage, miss, critical, shield) to the
	 * Server-Client packet Attack.<BR>
	 * <BR>
	 */
	public void addHit(L2Object target, int damage, boolean miss, boolean crit,
			boolean shld)
	{
	...
	/**
	 * Return True if the Server-Client packet Attack conatins at least 1
	 * hit.<BR>
	 * <BR>
	 */

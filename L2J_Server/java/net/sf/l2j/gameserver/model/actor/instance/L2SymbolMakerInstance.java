...
public class L2SymbolMakerInstance extends L2FolkInstance
{
	...
	private double _collisionHeight; // this is positioning the model relative
										// to the ground
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		{
			L2HennaInstance[] henna = HennaTreeTable.getInstance()
					.getAvailableHenna(player.getClassId());

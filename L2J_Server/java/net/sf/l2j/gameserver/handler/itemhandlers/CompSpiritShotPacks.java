...
public class CompSpiritShotPacks implements IItemHandler
{
	private static int[] _itemIds =
		{ 5140, 5141, 5142, 5143, 5144, 5145, 5256, 5257, 5258, 5259, 5260,
				5261 };
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		{ // Normal Compressed Package of SpiritShots
			itemToCreateId = itemId - 2631; // Gives id of matching item for
											// this pack
			amount = 300;
		} else
		{ // Greater Compressed Package of Spirithots
			itemToCreateId = itemId - 2747; // Gives id of matching item for
											// this pack
			amount = 1000;
		}

		activeChar.getInventory().destroyItem("Extract", item, activeChar,
				null);
		activeChar.getInventory().addItem("Extract", itemToCreateId, amount,
				activeChar, item);

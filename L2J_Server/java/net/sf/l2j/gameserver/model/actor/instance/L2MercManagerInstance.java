...
public final class L2MercManagerInstance extends L2FolkInstance
{
	...
	// Logger.getLogger(L2MercManagerInstance.class.getName());
	...
	private void showBuyWindow(L2PcInstance player, int val)
	{
		...
		if ((list != null)
				&& (list.getNpcId().equals(String.valueOf(getNpcId()))))
		{
	...
	public void showMessageWindow(L2PcInstance player)
	{
		...
		if (condition == Cond_Busy_Because_Of_Siege)
			...
			filename = "data/html/mercmanager/mercmanager.htm"; // Owner message
																// window
			...
			if (player.getClan() != null)
			{
																			...
																			// castle
				{
					if ((player.getClanPrivileges()
							& L2Clan.CP_CS_MERCENARIES) == L2Clan.CP_CS_MERCENARIES)
						return Cond_Owner;
				}
			}
		}

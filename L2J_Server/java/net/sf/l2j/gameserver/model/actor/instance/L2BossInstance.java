...
public final class L2BossInstance extends L2MonsterInstance
{
	...
	// Logger.getLogger(L2BossInstance.class.getName());
	 ...
	 * </ul>
	 * <br>
	 * <b>For now it's nothing more than a L2Monster but there'll be a
	 * scripting<br>
	 * engine for AI soon and we could add special behaviour for those
	 * boss</b><br>
	 * <br>
	 *
	 * @param objectId

...
/**
 * Format: ddb d: session id d: protocol revision b: 0x90 bytes : 0x80 bytes for
 * the scrambled RSA public key 0x10 bytes at 0x00
 */
public class Init
{
	// format ddb
	...
	private static byte[] _content = // new byte[0x9b];
		{ (byte) 0x00, (byte) 0xfd, (byte) 0x8a, (byte) 0x22, (byte) 0x00, // session
																			// id
				(byte) 0x5a, (byte) 0x78, (byte) 0x00, (byte) 0x00, // protocol
																	// revision
																	// 0x785a or
																	// 0xc621,
																	// c621 has

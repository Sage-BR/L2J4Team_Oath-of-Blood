...
public class HennaEquipList extends ServerBasePacket
{
	...
	final void writeImpl()
	{
		...
		{
			/*
			 * Player must have at least one dye in inventory to be able to see
			 * the henna that can be applied with it.
			 */
			if ((_player.getInventory()
					.getItemByItemId(element.getItemIdDye())) != null)
			{

...
public enum L2WeaponType
{
	...
	SWORD(2, "Sword"), BLUNT(3, "Blunt"), DAGGER(4, "Dagger"), BOW(5,
			"Bow"), POLE(6, "Pole"), ETC(7, "Etc"), FIST(8, "Fist"), DUAL(9,
					"Dual Sword"), DUALFIST(10,
							"Dual Fist"), BIGSWORD(11, "Big Sword"), // Two
																		// Handed
																		// Swords
	PET(12, "Pet"), ROD(13, "Rod"), BIGBLUNT(14, "Big Blunt"); // Two handed
																// blunt

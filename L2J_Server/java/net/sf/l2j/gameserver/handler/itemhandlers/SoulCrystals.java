...
public class SoulCrystals implements IItemHandler
{
	...
	private static int[] _itemIds =
		{ 4629, 4630, 4631, 4632, 4633, 4634, 4635, 4636, 4637, 4638, 4639,
				5577, 5580, 5908, 4640, 4641, 4642, 4643, 4644, 4645, 4646,
				4647, 4648, 4649, 4650, 5578, 5581, 5911, 4651, 4652, 4653,
				4654, 4655, 4656, 4657, 4658, 4659, 4660, 4661, 5579, 5582,
				5914 };
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		if (((L2MonsterInstance) target)
				.getCurrentHp() > ((L2MonsterInstance) target).getMaxHp() / 2)
		{
			ActionFailed af = new ActionFailed();
			activeChar.sendPacket(af);
			return;
		...
		CrystalFinalizer cf = new CrystalFinalizer(activeChar, target,
				crystalId);
		ThreadPoolManager.getInstance().scheduleEffect(cf,
				skill.getSkillTime());
	...
	static class CrystalFinalizer implements Runnable
	{
		...
		CrystalFinalizer(L2PcInstance activeChar, L2Object target,
				int crystalId)
		{

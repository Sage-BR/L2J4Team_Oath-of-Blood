...
public class CharStat
{
			...
			L2Skill skill)
	{
		...
		if (env.value <= 0 && ((stat == Stats.MAX_HP) || (stat == Stats.MAX_MP)
				|| (stat == Stats.MAX_CP) || (stat == Stats.MAGIC_DEFENCE)
				|| (stat == Stats.POWER_DEFENCE) || (stat == Stats.POWER_ATTACK)
				|| (stat == Stats.MAGIC_ATTACK)
				|| (stat == Stats.POWER_ATTACK_SPEED)
				|| (stat == Stats.MAGIC_ATTACK_SPEED)
				|| (stat == Stats.SHIELD_DEFENCE) || (stat == Stats.STAT_CON)
				|| (stat == Stats.STAT_DEX) || (stat == Stats.STAT_INT)
				|| (stat == Stats.STAT_MEN) || (stat == Stats.STAT_STR)
				|| (stat == Stats.STAT_WIT)))
		{
			env.value = 1;
		}
	...
	public int getAccuracy()
	{
		...
		return (int) (calcStat(Stats.ACCURACY_COMBAT, 0, null, null)
				/ _ActiveChar.getWeaponExpertisePenalty());
	}
	...
	public final float getAttackSpeedMultiplier()
	{
		...
		return (float) ((1.1) * getPAtkSpd()
				/ _ActiveChar.getTemplate().basePAtkSpd);
	}
	...
	public final int getCON()
	{
		...
		return (int) calcStat(Stats.STAT_CON, _ActiveChar.getTemplate().baseCON,
				null, null);
	}
	...
	public int getCriticalHit(L2Character target, L2Skill skill)
	{
		...
		int criticalHit = (int) calcStat(Stats.CRITICAL_RATE,
				_ActiveChar.getTemplate().baseCritRate, target, skill);
	...
	public final int getDEX()
	{
		...
		return (int) calcStat(Stats.STAT_DEX, _ActiveChar.getTemplate().baseDEX,
				null, null);
	}
	...
	public int getINT()
	{
		...
		return (int) calcStat(Stats.STAT_INT, _ActiveChar.getTemplate().baseINT,
				null, null);
	}
	...
	{
		if (skill != null)
			return (int) calcStat(Stats.MAGIC_ATTACK_RANGE,
					skill.getCastRange(), null, skill);
	...
	public final int getMaxCp()
	{
		...
		return (int) calcStat(Stats.MAX_CP, _ActiveChar.getTemplate().baseCpMax,
				null, null);
	}
	...
	public int getMaxHp()
	{
		...
		return (int) calcStat(Stats.MAX_HP, _ActiveChar.getTemplate().baseHpMax,
				null, null);
	}
	...
	public int getMaxMp()
	{
		...
		return (int) calcStat(Stats.MAX_MP, _ActiveChar.getTemplate().baseMpMax,
				null, null);
	}
	...
	public int getMAtkSpd()
	{
		...
		double val = calcStat(Stats.MAGIC_ATTACK_SPEED,
				_ActiveChar.getTemplate().baseMAtkSpd, null, null);
	...
	public final int getMEN()
	{
		...
		return (int) calcStat(Stats.STAT_MEN, _ActiveChar.getTemplate().baseMEN,
				null, null);
	}
	...
	public final double getMReuseRate(L2Skill skill)
	{
		...
		return calcStat(Stats.MAGIC_REUSE_RATE,
				_ActiveChar.getTemplate().baseMReuseRate, null, skill);
	}
	...
	public int getPAtk(L2Character target)
	{
		...
		return (int) calcStat(Stats.POWER_ATTACK,
				_ActiveChar.getTemplate().basePAtk, target, null);
	}
	...
	public int getPAtkSpd()
	{
		...
		return (int) (calcStat(Stats.POWER_ATTACK_SPEED,
				_ActiveChar.getTemplate().basePAtkSpd, null, null)
				/ _ActiveChar.getArmourExpertisePenalty());
	}
	...
	public int getPDef(L2Character target)
	{
		...
		return (int) calcStat(Stats.POWER_DEFENCE,
				(_ActiveChar.isRaid())
						? _ActiveChar.getTemplate().basePDef
								* Config.RAID_DEFENCE_MULTIPLIER
						: _ActiveChar.getTemplate().basePDef,
				target, null);
	}
	...
	public final int getPhysicalAttackRange()
	{
		...
		return (int) calcStat(Stats.POWER_ATTACK_RANGE,
				_ActiveChar.getTemplate().baseAtkRange, null, null);
	}
	...
	public int getRunSpeed()
	{
		...
		int val = (int) calcStat(Stats.RUN_SPEED,
				_ActiveChar.getTemplate().baseRunSpd, null, null);
	...
	public final int getSTR()
	{
		...
		return (int) calcStat(Stats.STAT_STR, _ActiveChar.getTemplate().baseSTR,
				null, null);
	}
	...
	public final int getWIT()
	{
		...
		return (int) calcStat(Stats.STAT_WIT, _ActiveChar.getTemplate().baseWIT,
				null, null);
	}
	...
	public final int getMpConsume(L2Skill skill)
	{
		...
		if (skill.isDance() && _ActiveChar != null
				&& _ActiveChar.getDanceCount() > 0)
			mpconsume += _ActiveChar.getDanceCount()
					* skill.getNextDanceMpCost();
	...
	public final int getMpInitialConsume(L2Skill skill)
	{
		...
		return (int) calcStat(Stats.MP_CONSUME, skill.getMpInitialConsume(),
				null, skill);
	}
}

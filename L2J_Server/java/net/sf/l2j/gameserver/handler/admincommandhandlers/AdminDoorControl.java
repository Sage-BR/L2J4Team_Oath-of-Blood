...
/**
 * This class handles following admin commands: - open1 = open coloseum door
 * 24190001 - open2 = open coloseum door 24190002 - open3 = open coloseum door
 * 24190003 - open4 = open coloseum door 24190004 - openall = open all coloseum
 * door - close1 = close coloseum door 24190001 - close2 = close coloseum door
 * 24190002 - close3 = close coloseum door 24190003 - close4 = close coloseum
 * door 24190004 - closeall = close all coloseum door
 *
 * - open = open selected door - close = close selected door
 *
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		try
		{
			if (command.startsWith("admin_open "))
			{
				...
				{
					for (Castle castle : CastleManager.getInstance()
							.getCastles())

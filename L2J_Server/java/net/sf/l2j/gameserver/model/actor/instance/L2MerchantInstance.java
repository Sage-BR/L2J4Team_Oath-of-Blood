...
public class L2MerchantInstance extends L2FolkInstance
{
	...
	// Logger.getLogger(L2MerchantInstance.class.getName());
	...
	private void showWearWindow(L2PcInstance player, int val)
	{
		...
		if (list != null)
		{
			WearList bl = new WearList(list, player.getAdena(),
					player.getExpertiseIndex());
	...
	{
		if (player == null || player.getPet() != null || player.isMounted()
				|| player.isRentedPet())
			return;
		...
		if (!player.reduceAdena("Rent", (int) price, player.getLastFolkNPC(),
				true))
			return;
	...
	public void onActionShift(ClientThread client)
	{
		...
		if (player.getAccessLevel() >= Config.GM_ACCESSLEVEL)
		{
			...
			html1.append("<tr><td>Template ID: " + getTemplate().npcId
					+ "</td></tr>");
			html1.append("<tr><td><br></td></tr>");
			...
			html1.append(
					"<td><button value=\"Kill\" action=\"bypass -h admin_kill\" width=40 height=15 back=\"sek.cbui94\" fore=\"sek.cbui92\"></td></tr>");
			html1.append(

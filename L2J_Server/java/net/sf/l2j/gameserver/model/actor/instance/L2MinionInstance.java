...
/**
 * This class manages all Minions. In a group mob, there are one master called
...
public final class L2MinionInstance extends L2MonsterInstance
{
	...
	// Logger.getLogger(L2RaidMinionInstance.class.getName());

	/** The master L2Character whose depends this L2MinionInstance on */
	private L2MonsterInstance _master;

	/**
	 * Constructor of L2MinionInstance (use L2Character and L2NpcInstance
	 * constructor).<BR>
	 * <BR>
	 *
	 * <B><U> Actions</U> :</B><BR>
	 ...
	 * L2MinionInstance (copy skills from template to object and link

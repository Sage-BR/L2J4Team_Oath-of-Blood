...
public class ZoneType
{
	...
	{
		Arena, ArenaSpawn, CastleArea, CastleDefenderSpawn, ClanHall, Peace, SiegeBattleField, Town, TownSpawn, Underground, Water, NoLanding, Recharge, Damage, Fishing, Jail, MonsterDerbyTrack, OlympiadStadia, MotherTree
	}

	public static String[] ZoneTypeName =
		{ "Arena", "Arena Spawn", "Castle Area", "Castle Defender Spawn",
				"Clan Hall", "Peace", "Siege Battlefield", "Town", "Town Spawn",
				"Underground", "Water", "No Landing", "Recharge", "Damage",
				"Fishing", "Jail", "Monster Derby Track", "Olympiad Stadia",
				"MotherTree" };
	...
	public int addZoneCoord(String zoneName, int x1, int y1, int x2, int y2,
			int z)
	{
	...
	{
		for (Zone z : getZones())
			if (z.getName().equalsIgnoreCase(zoneName.trim()))
				return z;

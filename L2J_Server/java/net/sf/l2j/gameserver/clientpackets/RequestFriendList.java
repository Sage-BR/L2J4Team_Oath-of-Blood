...
public class RequestFriendList extends ClientBasePacket
{
	private static Logger _log = Logger
			.getLogger(RequestFriendList.class.getName());
	...
	void runImpl()
	{
		...
		try
		{
			...
			PreparedStatement statement = con.prepareStatement(
					"SELECT friend_id, friend_name FROM character_friends WHERE char_id=?");
			...
			activeChar.sendPacket(
					new SystemMessage(SystemMessage.FRIEND_LIST_HEAD));

...
public final class L2RaidBossInstance extends L2MonsterInstance
{
	...
	// Logger.getLogger(L2RaidBossInstance.class.getName());
	...
	public void doDie(L2Character killer)
	{
				...
				|| getNpcId() == 25220)
		{
			...
			L2NpcTemplate boxTemplate = NpcTable.getInstance()
					.getTemplate(boxId);
			final L2NpcInstance box = new L2NpcInstance(
					IdFactory.getInstance().getNextId(), boxTemplate);
	...
	protected void manageMinions()
	{
		...
		minionMaintainTask = ThreadPoolManager.getInstance()
				.scheduleGeneralAtFixedRate(new Runnable()
				{
					...
					public void run()
					{
						...
						if (!isInsideRadius(bossSpawn.getLocx(),
								bossSpawn.getLocy(), bossSpawn.getLocz(), 5000,
								true, false))
							teleToLocation(bossSpawn.getLocx(),
									bossSpawn.getLocy(), bossSpawn.getLocz(),
									true);

...
public class RequestRecipeShopMessageSet extends ClientBasePacket
{
	...
	// Logger.getLogger(RequestRecipeShopMessageSet.class.getName());

	private final String _name;

	public RequestRecipeShopMessageSet(ByteBuffer buf, ClientThread client)
	{
		super(buf, client);
		_name = readS();
	}
	...
	void runImpl()
	{
		...
		if (player == null)
			return;
		/*
		 * if (player.getCreateList() == null) { player.setCreateList(new
		 * L2ManufactureList()); }
		 */

...
public final class L2SiegeGuardInstance extends L2Attackable
{
	...
	public final SiegeGuardKnownList getKnownList()
	{
		if (super.getKnownList() == null
				|| !(super.getKnownList() instanceof SiegeGuardKnownList))
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		return (attacker != null && attacker instanceof L2PcInstance
				...
				&& !getCastle().getSiege()
						.checkIsDefender(((L2PcInstance) attacker).getClan()));
	}
	 ...
	 * need extra check to see if a player should interract ot ATTACK them when
	 * clicked.
	 *
	 */
	@Override
	public void onAction(L2PcInstance player)
	{
		...
		if (this != player.getTarget())
		{
			...
			// if ((isAutoAttackable(player))||(this instanceof
		...
		} else
		{
			...
			{
				if (Math.abs(player.getZ() - getZ()) < 600) // this max heigth
															// difference might
															// need some
															// tweaking
				{

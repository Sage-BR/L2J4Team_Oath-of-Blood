...
public class AdminShutdown implements IAdminCommandHandler
{
	...
	private static String[] _adminCommands =
		{ "admin_server_shutdown", "admin_server_restart",
				"admin_server_abort" };
	...
	private void sendHtmlForm(L2PcInstance activeChar)
	{
		...
		replyMSG.append("<tr><td>Players Online: "
				+ L2World.getInstance().getAllPlayersCount() + "</td></tr>");
		replyMSG.append("<tr><td>Used Memory: "
				+ (Runtime.getRuntime().totalMemory()
						- Runtime.getRuntime().freeMemory())
				+ " bytes</td></tr>");
		replyMSG.append("<tr><td>Server Rates: " + Config.RATE_XP + "x, "
				+ Config.RATE_SP + "x, " + Config.RATE_DROP_ADENA + "x, "
				+ Config.RATE_DROP_ITEMS + "x</td></tr>");
		replyMSG.append("<tr><td>Game Time: " + format.format(cal.getTime())
				+ "</td></tr>");
	...
	private void serverShutdown(L2PcInstance activeChar, int seconds,
			boolean restart)
	{

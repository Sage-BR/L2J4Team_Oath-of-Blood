...
public class FaenorEventParser extends FaenorParser
{
	...
	@Override
	public void parseScript(Node eventNode, @SuppressWarnings("unused")
	BSFManager context)
	{
		...
		eventDates = DateRange.parse(attribute(eventNode, "Active"),
				DATE_FORMAT);
	...
	static
	{
		ScriptEngine.parserFactories.put(getParserName("Event"),
				new FaenorEventParserFactory());
	}
}

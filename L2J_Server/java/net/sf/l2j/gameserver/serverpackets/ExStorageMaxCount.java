...
/**
 * Format: (ch)ddddddd d: Number of Inventory Slots d: Number of Warehouse Slots
 * d: Number of Freight Slots (unconfirmed) (200 for a low level dwarf) d:
 * Private Sell Store Slots (unconfirmed) (4 for a low level dwarf) d: Private
 * Buy Store Slots (unconfirmed) (5 for a low level dwarf) d: Dwarven Recipe
 * Book Slots d: Normal Recipe Book Slots
 *

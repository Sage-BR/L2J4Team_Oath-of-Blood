...
public class L2StaticObjectInstance extends L2Object
{
	private static Logger _log = Logger
			.getLogger(L2StaticObjectInstance.class.getName());
	...
	public void onAction(L2PcInstance player)
	{
		...
		} else
		{
			...
			// L2NpcInstance
			if (!player.isInsideRadius(this, INTERACTION_DISTANCE, false,
					false))
			{
			...
			} else
			{
				if (_type == 2)
				{
					...
					if (content == null)
						html.setHtml(
								"<html><head><body>Signboard is missing:<br>"
										+ filename + "</body></html>");
					else
					...
					player.sendPacket(
							new ShowTownMap(_texture, getMapX(), getMapY()));

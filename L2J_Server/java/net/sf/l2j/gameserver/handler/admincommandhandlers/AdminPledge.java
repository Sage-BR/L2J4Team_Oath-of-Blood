...
/**
 * Pledge Manipulation //pledge <create|dismiss|setlevel>
 */
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (command.startsWith("admin_pledge"))
		{
			...
			if (action.equals("create"))
			{
				...
				L2Clan clan = ClanTable.getInstance().createClan(target,
						pledgeName);
				if (clan != null)
				{
					activeChar.sendMessage("Clan " + pledgeName
							+ " created. Leader: " + target.getName());
				}
			...
			} else if (action.equals("setlevel"))
			{
				...
				activeChar.sendMessage("You set level " + level + " for clan "
						+ target.getClan().getName());
			}
		}

 ...
 * 04 00 // Item Type 1 : 00-weapon/ring/earring/necklace, 01-armor/shield,
 * 04-item/questitem/adena <BR>
 * c6 37 50 40 // ObjectId <BR>
 * cd 09 00 00 // ItemId <BR>
 * 05 00 00 00 // Quantity <BR>
 * 05 00 // Item Type 2 : 00-weapon, 01-shield/armor, 02-ring/earring/necklace,
 * 03-questitem, 04-adena, 05-item <BR>
 * 00 00 // Filler (always 0) <BR>
 * 00 00 // Equipped : 00-No, 01-yes <BR>
 * 00 00 // Slot : 0006-lr.ear, 0008-neck, 0030-lr.finger, 0040-head,
 * 0100-l.hand, 0200-gloves, 0400-chest, 0800-pants, 1000-feet, 4000-r.hand,
 * 8000-r.hand <BR>
 ...
 * <BR>
 *
 * @version $Revision: 1.3.2.2.2.4 $ $Date: 2005/03/27 15:29:39 $ Rebuild
 *          23.2.2006 by Advi
 */
...
public class InventoryUpdate extends ServerBasePacket
{
	private static Logger _log = Logger
			.getLogger(InventoryUpdate.class.getName());
	...
	final void writeImpl()
	{
		...
		for (ItemInfo item : _items)
		{
			...
			// writeH(temp.getItem().getBodyPart()); // rev 377 Slot 0006-lr.ear
			// 0008-neck 0030-lr.finger 0040-head 0080-?? 0100-l.hand
			// 0200-gloves 0400-chest 0800-pants 1000-feet 2000-?? 4000-r.hand
			// 8000-r.hand
			...
			writeH(item.getEnchant()); // Enchant level (pet level shown in
										// control item)
			writeH(item.getCustomType2()); // Pet name exists or not shown in
											// control item
		}
	}

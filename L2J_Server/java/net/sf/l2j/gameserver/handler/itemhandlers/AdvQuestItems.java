 ...
 *
 * @author DrLecter
 * @version 0.1 10/08/05 0039 Created for quest items with special needs. Mainly
 *          the c3 quests.
 */
...
public class AdvQuestItems implements IItemHandler
{
	...
	private static int[] award_parch =
		{ 5922, 5923, 5924, 5925, 5926, 5927, 5928, 5929, 5930, 5931, 5932,
				5933, 5934, 5935, 5936, 5937, 5938, 5939, 5940, 5941, 5942,
				5943 };

	private static int[] award_gbook =
		{ 5942, 5943, 5945, 5946, 5947, 5948, 5949, 5950, 5951, 5952, 5953,
				5954 };

	private static int[] award_papy1 =
		{ 5970, 5971, 5977, 5978, 5979, 5986, 5993, 5994, 5995, 5997, 5983,
				6001 };

	private static int[] award_papy2 =
		{ 5970, 5971, 5975, 5976, 5980, 5985, 5993, 5994, 5995, 5997, 5983,
				6001 };

	private static int[] award_papy3 =
		{ 5973, 5974, 5981, 5984, 5989, 5990, 5991, 5992, 5996, 5998, 5999,
				6000, 5988, 5983, 6001 };

	private static int[] award_papy4 =
		{ 5970, 5971, 5982, 5987, 5989, 5990, 5991, 5992, 5996, 5998, 5999,
				6000, 5972, 6001 };

	private static int[] award_pouch =
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		activeChar.getInventory().destroyItemByItemId("Extract",
				item.getItemId(), 1, activeChar, null);
		activeChar.getInventory().addItem("Extract", itemToCreateId, 1,
				activeChar, item);

 ...
 * <BR>
 *
 * c6 37 50 40 // Attribute Identifier : 01-Level, 02-Experience, 03-STR,
 * 04-DEX, 05-CON, 06-INT, 07-WIT, 08-MEN, 09-Current HP, 0a, Max HP...<BR>
...
public class StatusUpdate extends ServerBasePacket
{
	...
	{
		/**
		 * id values 09 - current health 0a - max health 0b - current mana 0c -
		 * max mana
		 *
		 */
		public int id;

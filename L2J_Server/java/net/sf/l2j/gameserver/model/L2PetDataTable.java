...
public class L2PetDataTable
{
	...
	public static final int[] petList =
		{ 12077, 12312, 12313, 12311, 12527, 12528, 12526 };
	...
	public void loadPetsData()
	{
		...
		try
		{
			...
			PreparedStatement statement = con.prepareStatement(
					"SELECT typeID, level, expMax, hpMax, mpMax, patk, pdef, matk, mdef, acc, evasion, crit, speed, atk_speed, cast_speed, feedMax, feedbattle, feednormal, loadMax, hpregen, mpregen FROM pets_stats");
	...
	{
		return (itemId == 2515) || (itemId == 4038) || (itemId == 5168)
				|| (itemId == 6316) || (itemId == 7582);
	}

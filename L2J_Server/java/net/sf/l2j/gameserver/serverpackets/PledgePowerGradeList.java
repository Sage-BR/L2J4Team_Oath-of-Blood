 ...
 *
 *
 * sample 0000: 9c c10c0000 48 00 61 00 6d 00 62 00 75 00 72 .....H.a.m.b.u.r
 * 0010: 00 67 00 00 00 00000000 00000000 00000000 00000000 00000000 00000000 00
 * 00 00000000 ...
 *
 * format dd ??
 *
...
public class PledgePowerGradeList extends ServerBasePacket
{
	...
	// Logger.getLogger(ServerBasePacket.class.getName());
	...
	final void writeImpl()
	{
		...
		for (RankPrivs _priv : _privs)
		{
			...
			// _log.warning("rank: "+_privs[i].getRank()+" party:
			// "+_privs[i].getParty());
		}

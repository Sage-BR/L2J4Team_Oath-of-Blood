...
public class Announcements
{
	...
	private List<List<Object>> eventAnnouncements = new FastList<>();
	...
	public void showAnnouncements(L2PcInstance activeChar)
	{
		...
		{
			CreatureSay cs = new CreatureSay(0, Say2.ANNOUNCEMENT,
					activeChar.getName(), _announcement.toString());
	...
	public void listAnnouncements(L2PcInstance activeChar)
	{
		...
		for (int i = 0; i < _announcements.size(); i++)
		{
			replyMSG.append("<table width=260><tr><td width=220>"
					+ _announcements.get(i).toString() + "</td><td width=40>");
			replyMSG.append(
					"<button value=\"Delete\" action=\"bypass -h admin_del_announcement "
							+ i
	...
	private void saveToDisk()
	{
		...
		try
		{
			...
			for (String _announcement : _announcements)
			{
				save.write(_announcement.toString());
				save.write("\r\n");
			}
			save.flush();
			save.close();

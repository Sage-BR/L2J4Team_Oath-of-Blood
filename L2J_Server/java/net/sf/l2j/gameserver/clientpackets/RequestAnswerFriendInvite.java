...
public class RequestAnswerFriendInvite extends ClientBasePacket
{
	...
	private static Logger _log = Logger
			.getLogger(RequestAnswerFriendInvite.class.getName());
	...
	void runImpl()
	{
		...
		if (player != null)
		{
			...
			if (_response == 1)
			{
				...
				try
				{
					...
					PreparedStatement statement = con.prepareStatement(
							"INSERT INTO character_friends (char_id, friend_id, friend_name) VALUES (?, ?, ?), (?, ?, ?)");
			...
			{
				SystemMessage msg = new SystemMessage(
						SystemMessage.FAILED_TO_INVITE_A_FRIEND);
				requestor.sendPacket(msg);
				msg = null;
			}

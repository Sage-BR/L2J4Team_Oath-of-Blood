...
public class SystemMessage extends ServerBasePacket
{
	...
	public static final int PLEACE_CHECK_YOUR_FRIEND_LIST_AGAIN = 134; // not
																		// used

	public static final int YOU_CANNOT_ADD_YOURSELF_TO_OWN_FRIEND_LIST = 165;

	public static final int FRIEND_LIST_NOT_READY_YET_REGISTER_LATER = 166; // not
																			// used
	...
	public static final int THE_PLAYER_IS_REJECTING_FRIEND_INVITATIONS = 662; // not
																				// used
	...
	public static final int S1_DIED_DROPPED_S3_S2 = 1208;// $s1 died and dropped
															// $s3 $s2.

...
public class L2DatabaseFactory
{
	...
	public L2DatabaseFactory() throws SQLException
	{
		try
		{
			if (Config.DATABASE_MAX_CONNECTIONS < 2)
			{
				...
				_log.warning("at least " + Config.DATABASE_MAX_CONNECTIONS
			...
			_source.setAcquireIncrement(5); // if pool is exhausted, get 5 more
			...
			// already there
			_source.setAutomaticTestTable("connection_test_table"); // very very
																	// fast
																	// test,
																	// don't
																	// worry
			_source.setTestConnectionOnCheckin(true); // this will *not* make
														// l2j slower in any way

			// testing OnCheckin used with IdleConnectionTestPeriod is faster
			// than testing on checkout

			_source.setIdleConnectionTestPeriod(60); // test idle connection
														// every 60 sec
	...
	public Connection getConnection() // throws SQLException
	{
		...
		while (con == null)
		{
			...
			{
				_log.warning(
						"L2DatabaseFactory: getConnection() failed, trying again "
								+ e);
			}
		}
		return con;

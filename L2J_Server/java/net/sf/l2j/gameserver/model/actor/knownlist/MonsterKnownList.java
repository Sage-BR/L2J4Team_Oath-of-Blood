...
public class MonsterKnownList extends AttackableKnownList
{
	...
	public boolean addKnownObject(L2Object object, L2Character dropper)
	{
		...
		if (object instanceof L2PcInstance && getActiveChar().getAI()
				.getIntention() == CtrlIntention.AI_INTENTION_IDLE)
			getActiveChar().getAI()
					.setIntention(CtrlIntention.AI_INTENTION_ACTIVE, null);
		return true;
	}
	...
	public boolean removeKnownObject(L2Object object)
	{
		...
		if (getActiveChar().hasAI())
		{
			...
			getActiveChar().getAI().notifyEvent(CtrlEvent.EVT_FORGET_OBJECT,
					object);

			// TODO Remove this function because it's already done in
			// L2Character.removeKnownObject
			// Set the current target to null if the forgotten L2Object was the
			// targeted L2Object
		...
		if (getActiveChar().isVisible() && getKnownPlayers().isEmpty())
		{
			...
			// L2MonsterInstance then cancel Attak or Cast and notify AI
			// removeAllKnownObjects();

			// TODO Remove this function because it's already done in
			// L2Attackable.removeKnownObject

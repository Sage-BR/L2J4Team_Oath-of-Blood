...
public class AuthRequest extends GameServerBasePacket
{
	 ...
	 * @param maxplayer
	 */
	public AuthRequest(int id, boolean acceptAlternate, byte[] hexid,
			String externalHost, String internalHost, int port,
			boolean reserveHost, int maxplayer)
	{
		writeC(0x01);
		writeC(id);
	 ...
	 *
	 * @see
	 * net.sf.l2j.gameserver.gameserverpackets.GameServerBasePacket#getContent()
	 */
	@Override

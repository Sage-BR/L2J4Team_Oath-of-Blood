...
final class DocumentItem extends DocumentBase
{
	...
	private List<L2Item> itemsInFile = new FastList<>();
	...
	private void makeItem()
	{
		...
		if (currentItem.type instanceof L2ArmorType)
			currentItem.item = new L2Armor((L2ArmorType) currentItem.type,
					currentItem.set);
		else if (currentItem.type instanceof L2WeaponType)
			currentItem.item = new L2Weapon((L2WeaponType) currentItem.type,
					currentItem.set);
		else if (currentItem.type instanceof L2EtcItemType)
			currentItem.item = new L2EtcItem((L2EtcItemType) currentItem.type,
					currentItem.set);
		else

...
public class OlympiadStadiaManager
{
	protected static Logger _log = Logger
			.getLogger(OlympiadStadiaManager.class.getName());
	...
	{
		return (getOlympiadStadia(obj) != null);
	}

	/** Return true if object is inside zone */
	public final boolean checkIfInZone(int x, int y)
	{
		return (getOlympiadStadia(x, y) != null);
	}
	...
	public final OlympiadStadia getOlympiadStadia(int olympiadStadiaId)
	{
		...
		if (index >= 0)
			return getOlympiadStadias().get(index);
		return null;
	}

	public final OlympiadStadia getOlympiadStadia(L2Object activeObject)
	{
		return getOlympiadStadia(activeObject.getPosition().getX(),
	...
	public final int getOlympiadStadiaIndex(int olympiadStadiaId)
	{
		...
		for (int i = 0; i < getOlympiadStadias().size(); i++)
		{
			...
			if (OlympiadStadia != null
					&& OlympiadStadia.getOlympiadStadiaId() == olympiadStadiaId)
				return i;
		}
		return -1;
	}

	public final int getOlympiadStadiaIndex(L2Object activeObject)
	{
		return getOlympiadStadiaIndex(activeObject.getPosition().getX(),
				activeObject.getPosition().getY());
	}
	...
	public final int getOlympiadStadiaIndex(int x, int y)
	{
		...
		{
			OlympiadStadia = getOlympiadStadias().get(i);
			if (OlympiadStadia != null && OlympiadStadia.checkIfInZone(x, y))
				return i;
		}
		return -1;
	}
	...
	public final int getOlympiadStadiaIndex(String name)
	{
		...
		for (int i = 0; i < getOlympiadStadias().size(); i++)
		{
			OlympiadStadia = getOlympiadStadias().get(i);
			if (OlympiadStadia != null
					&& OlympiadStadia.getName().equalsIgnoreCase(name.trim()))
				return i;
		}
		return -1;
	}

...
public class MoveToLocationInVehicle extends ServerBasePacket
{
	 ...
	 * @param origin
	 */
	public MoveToLocationInVehicle(L2Character actor,
			L2CharPosition destination, L2CharPosition origin)
	{
		 ...
		 * _pci.sendMessage("_boat : x " + _pci.getBoat().getX() +" y " +
		 * _pci.getBoat().getY() + " z " + _pci.getBoat().getZ());
		 * _pci.sendMessage("-----------");
		 */
	}

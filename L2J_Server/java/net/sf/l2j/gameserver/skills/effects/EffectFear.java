...
final class EffectFear extends L2Effect
{
	...
	{
		// Fear skills cannot be used l2pcinstance to l2pcinstance. Heroic Dread
		// is the exception.
		if ((getEffected() instanceof L2PcInstance
				&& getEffector() instanceof L2PcInstance
				&& getSkill().getId() != 1376)
				|| (getEffected() instanceof L2FolkInstance))
			return false;

...
public class L2PlayerAI extends L2CharacterAI
{
	...
	class IntentionCommand
	{
		...
		protected IntentionCommand(CtrlIntention pIntention, Object pArg0,
				Object pArg1)
		{
			...
			Object arg1)
	{
		...
		if ((intention != AI_INTENTION_CAST) || (intention == _intention
				&& arg0 == _intention_arg0 && arg1 == _intention_arg1))
		{
		 ...
		 * warning("L2PlayerAI: changeIntention -> Saving current intention: " +
		 * _intention + " " + _intention_arg0 + " " + _intention_arg1);
		 */

		// push current intention to stack
		_interuptedIntentions.push(new IntentionCommand(_intention,
				_intention_arg0, _intention_arg1));
		super.changeIntention(intention, arg0, arg1);
	}
	...
	protected void onEvtFinishCasting()
	{
		...
		if (getIntention() == AI_INTENTION_CAST)
		{
			...
			if (!_interuptedIntentions.isEmpty())
			{
				...
				/*
				 * if (Config.DEBUG)
				 * _log.warning("L2PlayerAI: onEvtFinishCasting -> " +
				 * cmd._intention + " " + cmd._arg0 + " " + cmd._arg1);
				 */

				if (cmd != null && cmd.intention != AI_INTENTION_CAST) // previous
																		// state
																		// shouldn't
																		// be
																		// casting
			...
			} else
			{
				/*
				 * if (Config.DEBUG) _log.
				 * warning("L2PlayerAI: no previous intention set... Setting it to IDLE"
				 * );
				 */
	...
	private void thinkInteract()
	{
		...
		if (!(target instanceof L2StaticObjectInstance))
			((L2PcInstance.AIAccessor) _accessor)
					.doInteract((L2Character) target);
		setIntention(AI_INTENTION_IDLE);
		return;
	}
	...
	protected void onEvtArrivedRevalidate()
	{
		ThreadPoolManager.getInstance()
				.executeTask(new KnownListAsynchronousUpdateTask(_actor));

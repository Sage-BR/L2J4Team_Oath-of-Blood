...
public class AdminTest implements IAdminCommandHandler
{
	...
	public static final String[] ADMIN_TEST_COMMANDS =
		{ "admin_test", "admin_stats", "admin_skill_test", "admin_st",
				"admin_mp", "admin_known" };
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		} else if (command.startsWith("admin_test uni"))
		{
			activeChar.sendMessage(
					"Universe Map Size is: " + Universe.getInstance().size());
	...
	private void adminTestSkill(L2PcInstance activeChar, int id)
	{
		...
		player.broadcastPacket(
				new MagicSkillUser(activeChar, player, id, 1, 1, 1));

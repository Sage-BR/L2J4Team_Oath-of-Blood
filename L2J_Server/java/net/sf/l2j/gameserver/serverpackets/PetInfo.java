...
public class PetInfo extends ServerBasePacket
{
	...
	final void writeImpl()
	{
		...
		writeD(_summon instanceof L2PetInstance
				? _summon.getInventory().getTotalWeight()
				: 0);// weight
		...
		writeD(0);// c2 abnormal visual effect... bleed=1; poison=2; poison &
					// bleed=3; flame=4;
		...
		writeD(_summon.getUsedSoulShots());
		writeD(_summon.getUsedSpiritShots());
	}

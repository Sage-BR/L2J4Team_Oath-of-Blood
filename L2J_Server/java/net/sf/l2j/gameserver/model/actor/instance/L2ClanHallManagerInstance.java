...
public class L2ClanHallManagerInstance extends L2FolkInstance
{
		...
		else if (condition == Cond_Owner)
		{
			...
			} else if (actualCommand.equalsIgnoreCase("manage_vault"))
			{
				if ((player.getClanPrivileges()
						& L2Clan.CP_CL_VIEW_WAREHOUSE) == L2Clan.CP_CL_VIEW_WAREHOUSE)
				{
			...
			{
				if ((player.getClanPrivileges()
						& L2Clan.CP_CH_OPEN_DOOR) == L2Clan.CP_CH_OPEN_DOOR)
				{
			...
			} else if (actualCommand.equalsIgnoreCase("functions"))
			{
				...
				{
					if (getClanHall()
							.getFunction(ClanHall.FUNC_TELEPORT) == null)
						return;
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile("data/html/clanHallManager/tele"
							+ getClanHall().getLocation()
							+ getClanHall().getFunction(ClanHall.FUNC_TELEPORT)
									.getLvl()
							+ ".htm");
					sendHtmlMessage(player, html);
				...
				{
					if (getClanHall()
							.getFunction(ClanHall.FUNC_ITEM_CREATE) == null)
						return;
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile("data/html/clanHallManager/item"
							+ getClanHall().getLocation()
							+ getClanHall()
									.getFunction(ClanHall.FUNC_ITEM_CREATE)
									.getLvl()
							+ ".htm");
					sendHtmlMessage(player, html);
				...
				{
					if (getClanHall()
							.getFunction(ClanHall.FUNC_SUPPORT) == null)
						return;
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile("data/html/clanHallManager/support"
				...
				else
				{
					...
					if (getClanHall()
						...
						html.replace("%xp_regen%",
								String.valueOf(getClanHall()
										.getFunction(ClanHall.FUNC_RESTORE_EXP)
										.getLvl()) + "%");
					else
			...
			{
				if ((player.getClanPrivileges()
						& L2Clan.CP_CH_SET_FUNCTIONS) == L2Clan.CP_CH_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						...
						{
							player.sendMessage(
									"Your clan hall's grade is too low to use these functions");
							return;
						}
						if (st.countTokens() >= 1)
						{
							...
							if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_RESTORE_HP, percent,
											fee, Config.CH_HPREG_FEE_RATIO,
											Calendar.getInstance()
													.getTimeInMillis()
													+ Config.CH_HPREG_FEE_RATIO,
											(getClanHall().getFunction(
													ClanHall.FUNC_RESTORE_HP) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							} else if (val.equalsIgnoreCase("mp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_RESTORE_MP, percent,
											fee, Config.CH_MPREG_FEE_RATIO,
											Calendar.getInstance()
													.getTimeInMillis()
													+ Config.CH_MPREG_FEE_RATIO,
											(getClanHall().getFunction(
													ClanHall.FUNC_RESTORE_MP) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							} else if (val.equalsIgnoreCase("exp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_RESTORE_EXP, percent,
											fee, Config.CH_EXPREG_FEE_RATIO,
											Calendar.getInstance()
													.getTimeInMillis()
													+ Config.CH_EXPREG_FEE_RATIO,
											(getClanHall().getFunction(
													ClanHall.FUNC_RESTORE_EXP) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							}
							// int percent = Integer.valueOf(val);
							// getClanHall().updateFunctions(new
							// ClanHallFunction(),
							// (getClanHall().getFunction()))
						} else
						{
							NpcHtmlMessage html = new NpcHtmlMessage(1);
							html.setFile(
									"data/html/clanHallManager/edit_recovery.htm");
							if (getClanHall().getFunction(
									ClanHall.FUNC_RESTORE_HP) != null)
							{
								html.replace("%hp%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_HP)
												.getLvl())
										+ "%");
								html.replace("%hpPrice%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_HP)
												.getLease()));
								html.replace("%hpDate%",
										format.format(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_HP)
												.getEndTime()));
							} else
							{
							...
							if (getClanHall().getFunction(
									ClanHall.FUNC_RESTORE_EXP) != null)
							{
								html.replace("%exp%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_EXP)
												.getLvl())
										+ "%");
								html.replace("%expPrice%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_EXP)
												.getLease()));
								html.replace("%expDate%",
										format.format(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_EXP)
												.getEndTime()));
							} else
							...
							if (getClanHall().getFunction(
									ClanHall.FUNC_RESTORE_MP) != null)
							{
								html.replace("%mp%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_MP)
												.getLvl())
										+ "%");
								html.replace("%mpPrice%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_RESTORE_MP)
												.getLease()));
								html.replace("%mpDate%",
					...
					} else if (val.equalsIgnoreCase("other"))
					{
						...
						if (st.countTokens() >= 1)
						{
							...
							if (val.equalsIgnoreCase("item"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_ITEM_CREATE, lvl,
											76000, 86400000,
											Calendar.getInstance()
													.getTimeInMillis()
													+ 86400000,
											(getClanHall().getFunction(
													ClanHall.FUNC_ITEM_CREATE) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							} else if (val.equalsIgnoreCase("tele"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_TELEPORT, lvl, fee,
											Config.CH_TELE_FEE_RATIO,
											Calendar.getInstance()
													.getTimeInMillis()
													+ Config.CH_TELE_FEE_RATIO,
											(getClanHall().getFunction(
													ClanHall.FUNC_TELEPORT) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							} else if (val.equalsIgnoreCase("support"))
							{
								if (st.countTokens() >= 1)
								{
									...
									if (!getClanHall().updateFunctions(
											ClanHall.FUNC_SUPPORT, lvl, fee,
											Config.CH_SUPPORT_FEE_RATIO,
											Calendar.getInstance()
													.getTimeInMillis()
													+ Config.CH_SUPPORT_FEE_RATIO,
											(getClanHall().getFunction(
													ClanHall.FUNC_SUPPORT) == null)))
										player.sendMessage(
												"You don't have enough adena in your clan's warehouse");
								}
							}
						...
						} else
						{
							NpcHtmlMessage html = new NpcHtmlMessage(1);
							html.setFile(
									"data/html/clanHallManager/edit_other.htm");
							if (getClanHall().getFunction(
									ClanHall.FUNC_TELEPORT) != null)
							{
								html.replace("%tele%",
										String.valueOf(getClanHall()
												...
												.getLvl()));
								html.replace("%telePrice%",
										String.valueOf(getClanHall()
												.getFunction(
														ClanHall.FUNC_TELEPORT)
												.getLease()));
								html.replace("%teleDate%",
										format.format(getClanHall()
												.getFunction(
														ClanHall.FUNC_TELEPORT)
												.getEndTime()));
							} else
									...
									.getFunction(ClanHall.FUNC_SUPPORT) != null)
							{
								html.replace("%support%",
										String.valueOf(getClanHall()
												...
												.getLvl()));
								html.replace("%supportPrice%",
										String.valueOf(getClanHall()
												.getFunction(
														ClanHall.FUNC_SUPPORT)
												.getLease()));
								html.replace("%supportDate%",
										format.format(getClanHall()
												.getFunction(
														ClanHall.FUNC_SUPPORT)
												.getEndTime()));
							...
							if (getClanHall().getFunction(
									ClanHall.FUNC_ITEM_CREATE) != null)
							{
								html.replace("%item%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_ITEM_CREATE)
												.getLvl()));
								html.replace("%itemPrice%", String
										.valueOf(getClanHall().getFunction(
												ClanHall.FUNC_ITEM_CREATE)
												.getLease()));
								html.replace("%itemDate%",
										format.format(getClanHall().getFunction(
												ClanHall.FUNC_ITEM_CREATE)
												.getEndTime()));
							} else
			...
			} else if (actualCommand.equalsIgnoreCase("support"))
			{
				...
				try
				{
					...
					try
					{
						...
						skill = SkillTable.getInstance().getInfo(skill_id,
								skill_lvl);
	...
	private void showMessageWindow(L2PcInstance player)
	{
		...
		if (condition > Cond_All_False)
		{
			if (condition == Cond_Owner) // Clan owns CH
				filename = "data/html/clanHallManager/chamberlain.htm"; // Owner
																		// message
																		// window
		}
	...
	public final ClanHall getClanHall()
	{
		if (_clanHallId < 0)
		{
			_clanHallId = ClanHallManager.getInstance()
					.getClanHall(getX(), getY(), 1500).getId();
			if (_clanHallId < 0)
				return null;
		}
	...
	private void showVaultWindowDeposit(L2PcInstance player)
	{
		...
		player.sendPacket(
				new WareHouseDepositList(player, WareHouseDepositList.Clan)); // Or
																				// Clan
																				// Hall??
	}
	...
	private void showVaultWindowWithdraw(L2PcInstance player)
	{
		...
		player.sendPacket(new WareHouseWithdrawalList(player,
				WareHouseWithdrawalList.Clan)); // Or Clan Hall ??
	}
	...
	private void doTeleport(L2PcInstance player, int val)
	{
		if (Config.DEBUG)
			player.sendMessage(
					"doTeleport(L2PcInstance player, int val) is called");
		L2TeleportLocation list = TeleportLocationTable.getInstance()
				.getTemplate(val);
		if (list != null)
		{
			// you cannot teleport to village that is in siege Not sure about
			// this one though
			if (SiegeManager.getInstance().checkIfInZone(list.getLocX(),
					list.getLocY()))
			{
				player.sendPacket(new SystemMessage(707));
				return;
			} else if (player.reduceAdena("Teleport", list.getPrice(), this,
					true))
			{
				if (Config.DEBUG)
					_log.warning("Teleporting player " + player.getName()
							+ " for CH to new location: " + list.getLocX() + ":"
							+ list.getLocY() + ":" + list.getLocZ());
				player.teleToLocation(list.getLocX(), list.getLocY(),
						list.getLocZ());
			}
		} else
		{

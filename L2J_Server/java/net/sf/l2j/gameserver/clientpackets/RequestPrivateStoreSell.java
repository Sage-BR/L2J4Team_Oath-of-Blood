...
//	private static final String _C__96_SENDPRIVATESTOREBUYBUYLIST = "[C] 96 SendPrivateStoreBuyBuyList";
	...
	private static Logger _log = Logger
			.getLogger(RequestPrivateStoreSell.class.getName());
	...
	public RequestPrivateStoreSell(ByteBuffer buf, ClientThread client)
	{
		...
		for (int i = 0; i < _count; i++)
		{
			...
			{
				String msgErr = "[RequestPrivateStoreSell] player "
	...
	void runImpl()
	{
		...
		{
			sendPacket(new ActionFailed());
			storePlayer.sendMessage(
					"You have not enough adena, canceling PrivateBuy.");

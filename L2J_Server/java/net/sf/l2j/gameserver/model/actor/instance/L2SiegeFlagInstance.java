...
public class L2SiegeFlagInstance extends L2NpcInstance
{
	...
	public L2SiegeFlagInstance(L2PcInstance player, int objectId,
			L2NpcTemplate template)
	{
		super(objectId, template);

		_Player = player;
		_Siege = SiegeManager.getInstance().getSiege(_Player.getX(),
				_Player.getY());
	...
	public boolean isAttackable()
	{
		...
		return (getCastle() != null && getCastle().getCastleId() > 0
	...
	public void onAction(L2PcInstance player)
	{
		...
		} else
		{
			...
			if (isAutoAttackable(player) && // Object is attackable
					Math.abs(player.getZ() - getZ()) < 100 // Less then max
															// height difference
			)

...
public class Continuous implements ISkillHandler
{
	...
	private static SkillType[] _skillIds =
		{ L2Skill.SkillType.BUFF, L2Skill.SkillType.DEBUFF,
				L2Skill.SkillType.DOT, L2Skill.SkillType.MDOT,
				L2Skill.SkillType.POISON, L2Skill.SkillType.BLEED,
				L2Skill.SkillType.HOT, L2Skill.SkillType.CPHOT,
			...
			L2Object[] targets)
	{
		...
		for (L2Object target2 : targets)
		{
			...
			if (skill.isOffensive())
			{
				...
				boolean acted = Formulas.getInstance()
						.calcMagicAffected(activeChar, target, skill);
				if (!acted)
				{
